...
import 'package:personal_safety/componants/BottomNavBar/bottom_curved_Painter.dart';
...
class _CustomBottomNavigationBarState extends State<CustomBottomNavigationBar>
  ...
  Widget _buildBackground() {
    final inCurve = ElasticOutCurve(0.0);
    return CustomPaint(
   ...
   _yController.value = 1.0;
    ...
    Future.delayed(
      Duration(milliseconds: 500),
          () {
        //_yController.animateTo(1.0, duration: Duration(milliseconds: 500));
      },
    );
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                _icon(Icons.notifications_active, _selectedIndex == 1, 1),
                _icon(Icons.location_on, _selectedIndex == 2, 2),
                _icon(Icons.new_releases, _selectedIndex == 3, 3),
              ],
            ),
          ),
        ],
